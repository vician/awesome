...
beautiful.init("/home/sansom/.config/awesome/themes/default/theme.lua")
...
os.execute("pgrep xautolock > /dev/null || (xautolock -time 10 -locker slock &)")
os.execute("pgrep owncloud > /dev/null || (owncloud &)")
os.execute("pgrep insync > /dev/null || (insync start &)")
-- }}}
